...
fn print_help() {
    ...
    println!(
        "  example <hello|caller|graphics|audio|agar-server|agar-client>  Start a named example (ports: hello=8080, caller=8081, graphics=8082, audio=8083, agar-server=8086, agar-client=8084)"
    );
    println!(
