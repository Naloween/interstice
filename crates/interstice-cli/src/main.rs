...
fn print_help() {
    ...
    println!(
        "  example <hello|caller|graphics|audio|agar-server|agar-client|ui|desktop>  Start a named example (ports: hello=8080, caller=8081, graphics=8082, audio=8083, agar-server=8086, agar-client=8084, ui=8088, desktop=8089)"
    );
    println!(
    ...
    println!("  benchmark simple <...>             Run simple benchmark workload");
